...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:d="http://docbook.org/ns/docbook" version="1.0">
    ...
    <!-- IMPORTS && INCLUDES -->
    <xsl:import href="https://raw.githubusercontent.com/Mobicents/jdocbook/master/docbook-xsl-1.77.1/xhtml/docbook.xsl"/>
    <xsl:include href="common-xhtml.xsl"/>

    <!--
        Customize titlepage rendering to add Mobicents.org and Community Documentation graphics to header
